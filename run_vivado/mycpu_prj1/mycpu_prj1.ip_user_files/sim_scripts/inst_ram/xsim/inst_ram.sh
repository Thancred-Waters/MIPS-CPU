...
#
# Generated by Vivado on Mon Aug 16 20:53:23 +0800 2021
...
# Script info
echo -e "inst_ram.sh - Script generated by export_simulation (Vivado v2021.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot inst_ram xil_defaultlib.inst_ram xil_defaultlib.glbl -log elaborate.log
}
