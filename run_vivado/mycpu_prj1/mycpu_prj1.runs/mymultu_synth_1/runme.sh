...
HD_PWD='D:/Programs/vivado/CPU_CDE/mycpu_verify/run_vivado/mycpu_prj1/mycpu_prj1.runs/mymultu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mymultu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mymultu.tcl
